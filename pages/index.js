  ...
  return (
    <div className="container">
      ...
      <main>
        ...
        <h3>Coming Events</h3> 
        <p className="description">
          1. Datathon Workshop: Saturday 25th of February Learn how to use Data Science to Improving Extreme Weather Forecasts with 
        ...
        <p className="description">
          2. Data Science Conference: more info coming soon...
        </p>
